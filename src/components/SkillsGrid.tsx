...
import { FaDatabase, FaCloud, FaJava, FaBolt, FaChartLine, FaNetworkWired } from "react-icons/fa";
...
const skills: Skill[] = [
  ...
  { name: "Go", href: "https://go.dev/", Icon: SiGo, group: "Languages", color: "#00ADD8" },
  { name: "Rust", href: "https://www.rust-lang.org/", Icon: SiRust, group: "Languages", color: "#F74C00" },
  ...
  { name: "LightGBM", href: "https://lightgbm.readthedocs.io/", Icon: FaBolt, group: "ML & Modeling", color: "#8FBC45" },
  { name: "MLflow", href: "https://mlflow.org/", Icon: SiMlflow, group: "ML & Modeling", color: "#0194E2" },

  /* ---------- BACKEND ---------- */
  { name: "FastAPI", href: "https://fastapi.tiangolo.com/", Icon: SiFastapi, group: "Backend", color: "#009688" },
  { name: "Spring Boot", href: "https://spring.io/projects/spring-boot", Icon: SiSpringboot, group: "Backend", color: "#6DB33F" },
  ...
  { name: "DuckDB", href: "https://duckdb.org/", Icon: SiDuckdb, group: "Backend", color: "#FFF000" },
  { name: "MySQL", href: "https://www.mysql.com/", Icon: SiMysql, group: "Backend", color: "#4479A1" },
  { name: "MongoDB", href: "https://www.mongodb.com/", Icon: SiMongodb, group: "Backend", color: "#47A248" },
  { name: "Supabase", href: "https://supabase.com/", Icon: SiSupabase, group: "Backend", color: "#3FCF8E" },
  { name: "Firebase", href: "https://firebase.google.com/", Icon: SiFirebase, group: "Backend", color: "#FFCA28" },

  /* ---------- DEVOPS ---------- */
  { name: "AWS", href: "https://aws.amazon.com/", Icon: SiAmazonwebservices, group: "DevOps", color: "#FF9900" },
  { name: "Azure", href: "https://azure.microsoft.com/", Icon: FaCloud, group: "DevOps", color: "#0078D4" },
  { name: "Terraform", href: "https://developer.hashicorp.com/terraform", Icon: SiTerraform, group: "DevOps", color: "#844FBA" },
  { name: "Ansible", href: "https://www.ansible.com/", Icon: SiAnsible, group: "DevOps", color: "#EE0000" },
  ...
  /* ---------- OBSERVABILITY ---------- */
  { name: "OpenTelemetry", href: "https://opentelemetry.io/", Icon: SiOpentelemetry, group: "Observability", color: "#F5A800" },
  ...
  { name: "AppDynamics", href: "https://www.appdynamics.com/", Icon: FaChartLine, group: "Observability", color: "#6BB86A" },
  { name: "SolarWinds", href: "https://www.solarwinds.com/", Icon: FaNetworkWired, group: "Observability", color: "#F99D1C" },
